...
export const profileZh = {
  ...
  statement: "我的核心代表研究涵盖记忆构成、投影一致性筛选、持续学习路由与检索到提示分割。",
  location: "中国深圳",
};
...
const publicationTranslations: Array<Pick<Publication, "venue" | "contribution"> & { authorNote?: string }> = [
  {
    venue: "预印本",
    contribution: "我的第一作者研究，提出 BoundarySupport，在固定记忆与重建设置下揭示被遗漏的缺陷邻近正常证据。",
  },
  {
    venue: "预印本",
    contribution: "我的第一作者研究，通过受控候选图像资格实验区分记忆纯度与记忆效用。",
  },
  {
