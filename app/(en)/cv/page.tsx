...
export const metadata: Metadata = {
  title: "CV",
  description: "Curriculum vitae of Joongwon Chae, including research highlights, publications, and IELTS 6.5.",
  alternates: {
    canonical: "/cv/",
    ...
    <main id="main" className="page-main shell cv-page">
      <header className="page-heading cv-heading">
        <div>
          ...
          <p>English CV with research highlights, publications, and IELTS 6.5.</p>
        </div>
